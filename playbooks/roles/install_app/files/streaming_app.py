...
logging.info(f'IDS_TO_FOLLOW_LIST: {IDS_TO_FOLLOW_LIST}')
...
logging.info(f'IDS_NOT_TO_RETWEET_ANYTHING: {IDS_NOT_TO_RETWEET_ANYTHING_LIST}')
...
logging.info(f'IDS_TO_RETWEET_RETWEETS: {IDS_TO_RETWEET_RETWEETS_LIST}')

IDS_TO_RETWEET_QUOTES = os.getenv('IDS_TO_RETWEET_QUOTES', '')
IDS_TO_RETWEET_QUOTES_LIST = create_list(IDS_TO_RETWEET_QUOTES)
logging.info(f'IDS_TO_RETWEET_QUOTES: {IDS_TO_RETWEET_QUOTES_LIST}')
...
logging.info(f'IDS_TO_REWTWEET_REPLIES: {IDS_TO_REWTWEET_REPLIES_LIST}')
